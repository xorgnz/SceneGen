...
<script src="${base_url}scripts/query/query_form.js">;</script>
...
[
    ...
    <c:if test="${co.parameters[i].variable != ''}">
    {
        ...
        flag_entityId: ${co.parameters[i].flag_entityId},
        flag_entityName: ${co.parameters[i].flag_entityName},
    },
     </c:if></c:forEach></c:if>
];
...
<div class="glue">
    ...
    <thead>
        ...
        <th width="247">Label</th>
        <th width="247">Flags</th>
        <th width="62"></th>
    </thead>
