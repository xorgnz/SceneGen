...
**************************************************************************/
var SB_UI_AddSceneFragment = function (container, config, builder)
{
    ...
    UI_Panel.embellish(this, "SB_UI_AddSceneFragment");
...
SB_UI_AddSceneFragment.prototype.buildUI = function ()
{
    // Self-reference
    var that = this;
    ...
    // Assemble
    this.container.appendChild(DOMUtils.header(1, "Add Scene Fragment"));
...
SB_UI_AddSceneFragment.prototype.buildUI_parameterFields = function (query)
{
    // Clear old fields
...
SB_UI_AddSceneFragment.prototype.open = function (fragment)
{
    if (this.isVisible())
...
SB_UI_AddSceneFragment.prototype._evt_closeForm = function ()
{
    // Self reference
    var that = this;
...
SB_UI_AddSceneFragment.prototype._evt_saveChanges = function ()
{
    // Self reference
    var that = this;
