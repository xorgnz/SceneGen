...
**************************************************************************/
var SB_UI_AddQueryFragment = function (container, config, builder)
{
    ...
    UI_Panel.embellish(this, "SB_UI_AddQueryFragment");
...
SB_UI_AddQueryFragment.prototype.buildUI = function ()
{
    // Self-reference
    var that = this;
    ...
    glue_form.appendChild(DOMUtils.br());
    ...
    // Assemble
    this.container.appendChild(DOMUtils.header(1, "Add Query-based Scene Fragment"));
...
SB_UI_AddQueryFragment.prototype.buildUI_parameterFields = function (query)
{
    // Clear old fields
...
SB_UI_AddQueryFragment.prototype.open = function (fragment)
{
    if (this.isVisible())
...
SB_UI_AddQueryFragment.prototype._evt_closeForm = function ()
{
    // Self reference
    var that = this;
...
SB_UI_AddQueryFragment.prototype._evt_saveChanges = function ()
{
    // Self reference
    var that = this;
