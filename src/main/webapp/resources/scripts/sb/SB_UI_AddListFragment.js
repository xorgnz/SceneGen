...
**************************************************************************/
var SB_UI_AddListFragment = function (container, config, builder, communicator)
{
    ...
    UI_Panel.embellish(this, "SB_UI_AddListFragment");
...
SB_UI_AddListFragment.prototype.buildUI = function ()
{
    // Self-reference
    var that = this;
    ...
    // Element - Name field
    this.htmlElements.input_name = DOMUtils.input("", "", "text");
    ...
    this.htmlElements.select_assetSet = DOMUtils.select(
        ...
        null);
    this.htmlElements.select_assetSet.onchange = function () { that.buildUI_assetList(that.config.assetSets[this.selectedIndex]); };
    ...
    // Assemble
    this.container.appendChild(DOMUtils.header(1, "Add List-based Scene Fragment"));
...
SB_UI_AddListFragment.prototype.buildUI_assetList = function (assetSet)
{
    // Self-reference
    var that = this;
...
SB_UI_AddListFragment.prototype.buildUI_assetList_postLoad = function (assetSet)
{
    // Clear old content
    while (this.htmlElements.assetListContainer.firstChild)
        this.htmlElements.assetListContainer.removeChild(this.htmlElements.assetListContainer.firstChild);
...
SB_UI_AddListFragment.prototype.open = function (fragment)
{
    if (this.isVisible())
        console.log("Popup form already open. Ignoring request to Add Scene Fragment");
    else
    {
...
SB_UI_AddListFragment.prototype._evt_closeForm = function ()
{
    // Self reference
    var that = this;
...
SB_UI_AddListFragment.prototype._evt_saveChanges = function ()
{
    // Self reference
    var that = this;
...
SB_UI_AddListFragment.prototype._evt_selectAll = function ()
{
    for (var i = 0 ; i < this.htmlElements.assetCheckboxes.length ; i ++)
...
SB_UI_AddListFragment.prototype._evt_selectNone = function ()
{
    for (var i = 0 ; i < this.htmlElements.assetCheckboxes.length ; i ++)
