...
@Controller
@RequestMapping("/REST/scene/add")
public class SceneRestController_PUT
{
    @Autowired
            ...
            HttpServletResponse response)
    {
        ...
        try
        {
            ...
            // Act
            Scene s = facade.addScene(co.getName());

            return new RestResponseObject(true, "", s.getId());
        }
        catch (Exception e)
        {
            e.printStackTrace();
    ...
    public static class RestResponseObject extends BasicRestResponseObject
    {
        ...
        public RestResponseObject(boolean success, String message, int id)
        {
