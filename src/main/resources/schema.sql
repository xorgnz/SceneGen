...
( 
    ...
    "queryp_tags" varchar(255) NOT NULL DEFAULT (''),
...
(
    ...
    "ssheet_description" text NOT NULL,
    "ssheet_tags" varchar(255),
...
(
    ...
    "scene_viewpoint_pos_x" float8,
    "scene_viewpoint_pos_y" float8,
    "scene_viewpoint_pos_z" float8,
    "scene_viewpoint_rot_x" float8,
    "scene_viewpoint_rot_y" float8,
    "scene_viewpoint_rot_z" float8,
    "scene_viewpoint_targ_x" float8,
    "scene_viewpoint_targ_y" float8,
    "scene_viewpoint_targ_z" float8,
    "scene_viewpoint_up_x" float8,
    "scene_viewpoint_up_y" float8,
    "scene_viewpoint_up_z" float8,
